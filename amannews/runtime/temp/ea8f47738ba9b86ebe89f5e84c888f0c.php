<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:78:"/usr/local/nginx/html/amannew/public/../application/index/view/free/lists.html";i:1528622604;s:71:"/usr/local/nginx/html/amannew/application/index/view/common/header.html";i:1528627673;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
                ...
                <ul class="con_ul">
                    ...
                    <li>
                        <a href="<?php echo $vo['url']; ?>" target="_blank">
                            <img src="/static/<?php echo $vo['thum']; ?>" alt="" width="364px" height="230px">
