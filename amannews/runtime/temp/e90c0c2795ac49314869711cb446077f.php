<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:87:"/usr/local/nginx/html/amannew/public/../application/index/view/free/small_language.html";i:1528607008;s:71:"/usr/local/nginx/html/amannew/application/index/view/common/header.html";i:1528600693;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <link rel="stylesheet" href="/static/index/css/XYZxy.css">
    ...
    <nav class="navbar navbar-default nther" id="nav">
        <div class="container-fluid">
            <div class="navbar-header">
                <a class="navbar-brand" href=""><img src="/static/index/img/logo.png" alt="" class="logo"/></a>
            </div>
        ...
        <div class="section section1">
            ...
            <ul class="uls">
                <li class="banner-book">
                    <a href="#"><img src="/static/index/img/xyz1.png" alt=""></a>
                    <a href="#"><img src="/static/index/img/xyz2.png" alt=""></a>
                    <a href="#"><img src="/static/index/img/xyz3.png" alt=""></a>
                    <a href="#"><img src="/static/index/img/xyz4.png" alt=""></a>
                    <a href="#"><img src="/static/index/img/xyz5.png" alt=""></a>
                </li>
            </ul>
        </div>
        <div id="content">
                ...
                <ul class="con_ul">
                    <li>
                        <a href="">
                            ...
                            <p >【雅思】阿蛮高分学员经验分享 白天明口语1</p>
                        </a>
                    </li>
                    <li>
                        <a href="">

                            <p >【雅思】阿蛮高分学员经验分享 白天明口语2</p>
                        </a>
                    </li>
                    <li>
                        <a href="">

                            <p>【雅思】阿蛮高分学员经验分享 白天明阅读1</p>
                        </a>
                    </li>
                    <li>
                        <a href="">

                            <p >【雅思】阿蛮高分学员经验分享 白天明阅读2</p>
                        </a>
                    </li>
                    <li>
                        <a href="">

                            <p>【雅思】阿蛮高分学员经验分享 白天明写作1</p>
                        </a>
                    </li>
                    <li>
                        <a href="">

                            <p>【雅思】阿蛮高分学员经验分享 白天明写作2</p>
                        </a>
                    </li>
                    <li>
                        <a href="">

                            <p>【雅思】阿蛮高分学员经验分享 白天明听力1</p>
                        </a>
                    </li>
                    <li>
                        <a href="">

                            <p>【雅思】阿蛮高分学员经验分享 白天明听力2</p>
                        </a>
                    </li>
                    <li>
                        <a href="">
